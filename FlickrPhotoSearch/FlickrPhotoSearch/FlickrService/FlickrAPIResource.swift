...
extension APIResource {
    ...
    func getQueryParams() -> String {
        ...
        let params = NSMutableDictionary.init(objects: [Constants.FlickrActionMethodsConstants.FLICKR_PHOTO_SEARCH_VALUE as NSCopying, Constants.FLICKR_API_KEY_VALUE as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_RESPONSE_FORMAT_VALUE as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_NO_JSON_CALL_BACK_VALUE as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_SAFE_SEARCH_KEY as NSCopying, searchQuery as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_SEARCH_PER_PAGE_VALUE as NSCopying], forKeys: [Constants.FlickrActionMethodsConstants.FLICKR_PHOTO_SEARCH_KEY as NSCopying, Constants.FLICKR_API_KEY_KEY as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_RESPONSE_FORMAT_KEY as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_NO_JSON_CALL_BACK_KEY as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_SAFE_SEARCH_KEY as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_SEARCH_TEXT_KEY as NSCopying, Constants.FlickrAdditionalParamConstants.FLICKR_SEARCH_PER_PAGE_KEY as NSCopying])
